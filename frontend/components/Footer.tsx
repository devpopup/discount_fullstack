      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div className="footer-column">
            ...
            <a
              href="mailto:info@popupreach.com"
              className="text-blue-200 hover:text-white transition-colors text-sm block"
            >
              info@popupreach.com
            </a>
        ...
        {/* Footer Bottom */}
        <div className="border-t border-[#2a4d6e] pt-8 text-center">
          <p className="text-sm text-blue-200">© 2025 PopupReach. All rights reserved.</p>
        </div>
      </div>
    </footer>
  )
